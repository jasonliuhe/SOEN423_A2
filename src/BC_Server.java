...
public class BC_Server {
    public static void main(String[] args) {
        Logger logger = Logger.getLogger("BC_SERVER");
        FileHandler fh = null;
        try {
            fh = new FileHandler("src/BC_SERVER/BC_SERVER.log", true);
        ...
        try {
            ...
            System.out.println("BC_SERVER ready and waiting ...");
            logger.info("BC_SERVER ready and waiting ...");
            ...
            try {
                aSocket = new DatagramSocket(500);
