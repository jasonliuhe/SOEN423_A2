...
public class QC_Server {
    public static void main(String[] args) {
        Logger logger = Logger.getLogger("QC_SERVER");
        FileHandler fh = null;
        try {
            fh = new FileHandler("src/QC_SERVER/QC_SERVER.log", true);
        ...
        try {
            ...
            String name = "QC_Server";
            NameComponent path[] = ncRef.to_name( name );
            ncRef.rebind(path, href);
            System.out.println("QC_SERVER ready and waiting ...");
            logger.info("QC_SERVER ready and waiting ...");
            ...
            try {
                aSocket = new DatagramSocket(300);
...
//                  log.logfile(userInterfaceImplementationClass.con_server, userInterfaceImplementationClass.con_server, "Request received in concordia server", "Request received", "Request received to server..." + requestData);
                    ...
                    if (rm[0].equals("purchaseitem")){
                        ...
                        res = functionImpl.findItem(rm[1], "QC", true);
                    }
